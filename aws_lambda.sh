...
aws lambda update-function-code --function-name UpdateRequest --zip-file fileb://UpdateRequest.zip
aws lambda update-function-configuration --function-name UpdateRequest --handler UpdateRequest.lambda_handler

aws lambda update-function-code --function-name FetchRequestDetails --zip-file fileb://FetchRequestDetails.zip
aws lambda update-function-configuration --function-name FetchRequestDetails --handler FetchRequestDetails.lambda_handler
